...
def FazLogin():
  ...
  url = 'https://sip.sgb.gov.br/sip/login.php?sigla_orgao_sistema=CPRM&sigla_sistema=SEI'
...
def ComplementaComDadosDoProcesso():
  ...
  def MudaJanela():
    ...
    browser.execute_script("window.open('https://sei.sgb.gov.br/sei/', '_blank')")
    ...
    browser.get('https://sei.sgb.gov.br/sei/')
