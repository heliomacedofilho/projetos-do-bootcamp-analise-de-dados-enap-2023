...
<<<<<<< Updated upstream:presenca_das_politicas_publicas_sociais_nos_municipios/Streamlit/pages/👩🏼‍🦽_👵Benefício_de_Prestação_Continuada_-_BPC.py

#carregando os dados
df = pd.read_csv('data\df_bpc_fpm_completa.csv')
georreferenciamento_df = pd.read_csv('data\georreferenciamento_df.csv')
=======
>>>>>>> Stashed changes:presenca_das_politicas_publicas_sociais_nos_municipios/Streamlit/pages/👩🏼_🦽_👵Benefício_de_Prestação_Continuada_-_BPC.py
